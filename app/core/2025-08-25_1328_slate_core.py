...
def new_pairing(
    ...
    if not ("ahid" in etypes):
        ...
        with sqlite3.connect(ENTITIES_DB) as conn:
            ...
            conn.commit()
            cursor.close()
    # At this point, the *accounts* list for this *ahid* is empty. Whether or
    # not it has been necessary to create the new *ahid* here, this list will
    # have to be extended only after the *account* has been created below.
